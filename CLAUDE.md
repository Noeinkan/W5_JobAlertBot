...
| `src/sources/*.js` | **24** source adapters (see `src/index.js` `sourceClients`; shared helpers: `stepstone_platform.js`, `next_data_extract.js`, `browser.js` for JS-rendered pages) |
